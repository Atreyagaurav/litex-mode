...
;; format tests
(ert-deftest litex-format-slime-output-test ()
  ...
  (should (string= (litex-format-slime-output '1/2) "\\frac{1}{2}"))
  (should (string= (litex-format-slime-output '1/20000)
		   "\\frac{1}{2 \\times 10^{4}}"))
  (should (string= (litex-format-slime-output '1) "1"))
  (should (string= (litex-format-slime-output '1.0001) "1.000"))))
